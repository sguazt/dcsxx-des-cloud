															    ...
															    typename TraitsT::real_type> const& vm_util_map)
{
	...
	return detail::make_initial_vm_placement_problem_data(dc, wp, ws, ref_penalty, vm_util_map, tmp_pm_ids, tmp_vm_ids);
}
...
/*
	...
	typedef typename data_center_type::application_type application_type;
	typedef typename application_type::reference_physical_resource_type reference_resource_type;
	typedef vm_placement_problem<traits_type> problem_description_type;
	typedef typename problem_description_type::physical_machine_identifier_container physical_machine_identifier_container;
	typedef typename problem_description_type::virtual_machine_identifier_container virtual_machine_identifier_container;

	problem_description_type problem;

	::std::ostringstream oss;

	oss << detail::make_initial_vm_placement_problem_model()
		<< "data;"
		<< ::std::endl;
	...
	problem.pm_ids = physical_machine_identifier_container(n_pms);
	problem.vm_ids = virtual_machine_identifier_container(n_vms);
													    ...
													    typename TraitsT::real_type> const& vm_util_map)
{
	...
	return detail::make_vm_placement_problem_data(dc, wp, ws, wm, vm_util_map, tmp_pm_ids, tmp_vm_ids);
}
...
/*
	...
	oss << detail::make_vm_placement_problem_model()
		<< "data;"
		<< ::std::endl;
